...
class User(AbstractUser):
    class SecurityQuestion(models.TextChoices):
        MAIDEN_NAME=(
           "maiden_name",  _("What is your father name")
        )
        FAVORITE_COLOR=(
           "favorite_color",  _("What is your favorite color")
        )
        BIRTH_CITY=(
           "birth_city",  _("What is the city where you were born")
        )
        CHILDHOOD_FRIEND =(
           "childhood_friend",  _("What is the name of your childhood best friend? ")
        )
    ...
    account_status= models.CharField(_("Account Status"), max_length=10, default=AccountStatus.ACTIVE, choices=AccountStatus.choices)
